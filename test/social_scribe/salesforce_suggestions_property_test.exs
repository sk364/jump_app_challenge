defmodule SocialScribe.CrmSuggestions.SalesforcePropertyTest do
  ...
  describe "merge_with_contact/3 properties for salesforce" do
  ...
  defp get_contact_value(contact, field) do
    # Map Salesforce field names to the atom keys used in formatted contacts
